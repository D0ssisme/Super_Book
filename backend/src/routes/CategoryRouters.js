...
import { createCategory, deleteCategory, getAllCategories, getCategoryByValue, updateCategory } from '../controllers/CategoryController.js';
...
router.get("/:value", getCategoryByValue);
router.use(auth)
